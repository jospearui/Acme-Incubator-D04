...
<acme:list>
	...
	<acme:list-column code="authenticated.activity.list.label.start" path="start" width="30%"/>
	<acme:list-column code="authenticated.activity.list.label.end" path="end" width="30%"/>
